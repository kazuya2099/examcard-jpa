			...
			<div class="col-sm-10 content-block">
				<div class="main-contents">
					<div class="customer-search">
								...
								<tr>
									...
									<td>
										<form:select path="applicationStatus">
											<cus:options id="applicationStatus" itemLabel="value" itemValue="key"/>
										</form:select>
						...
						<c:if test="${searchResultDto.customerApplicationDtos != null}">
							<c:if test="${searchResultDto.searchCount == 0}">
								<div class="customer-search-result">
									<h3>該当するお客様はいませんでした。</h3>
								</div>
							</c:if>
							<c:if test="${searchResultDto.searchCount > 0}">
								<c:out value="${searchResultDto.searchCount}"/>件 該当しました。
								<div class="pagenation">
									<ul>
										<li><a>prev</a></li>
										<li><span><c:out value="${searchCustomerForm.pageNo}"/></span></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 1}"/>)"><c:out value="${searchCustomerForm.pageNo + 1}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 2}"/>)"><c:out value="${searchCustomerForm.pageNo + 2}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 3}"/>)"><c:out value="${searchCustomerForm.pageNo + 3}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 4}"/>)"><c:out value="${searchCustomerForm.pageNo + 4}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 5}"/>)"><c:out value="${searchCustomerForm.pageNo + 5}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 6}"/>)"><c:out value="${searchCustomerForm.pageNo + 6}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 7}"/>)"><c:out value="${searchCustomerForm.pageNo + 7}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 8}"/>)"><c:out value="${searchCustomerForm.pageNo + 8}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 9}"/>)"><c:out value="${searchCustomerForm.pageNo + 9}"/></a></li>
										<li><a href="#" onclick="submit(<c:out value="${searchCustomerForm.pageNo + 9}"/>)">next</a></li>
									</ul>
								</div>
								<div class="customer-search-result">
									<table>
									...
									<c:forEach var="customerApplication" items="${searchResultDto.customerApplicationDtos}" varStatus="rowStatus">
									<tr>
										...
										<td>
											<a href="${pageContext.request.contextPath}/customer/sales/edit/detail?id=${customerApplication.id}" class="btn btn-primary">参照</a>
										</td>
									</tr>
									</c:forEach>
									</table>
