			...
			<div class="col-sm-10 content-block">
				<div class="main-contents">
					<div class="customer-search">
						...
						<form:form name="search" method="GET" action="${pageContext.request.contextPath}/application/search02/search" modelAttribute="applicationSearch02Form">
								...
								<c:if test="${outputDto.searchCount > 0}">
									...
									<div class="customer-search-result">
										...
										<tr>
											...
											<td>
												<a href="/application/update02/input?id=${customerApplication.id}" class="btn btn-primary">判定登録</a>
											</td>
										</tr>
										</c:forEach>
										</table>
